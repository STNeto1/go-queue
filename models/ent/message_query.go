...
func (mq *MessageQuery) QueryQueue() *QueueQuery {
	query := &QueueQuery{config: mq.config}
...
func (mq *MessageQuery) WithQueue(opts ...func(*QueueQuery)) *MessageQuery {
	query := &QueueQuery{config: mq.config}
